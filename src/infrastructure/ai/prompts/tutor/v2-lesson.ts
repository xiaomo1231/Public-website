/**
 * v2 of the Tutor *lesson* prompt.
 *
 * v2 adds one section: when a topic suits a diagram, the lesson should contain
 * ONE short, self-contained, numerically explicit example that the separate
 * visualization call can reuse verbatim. Everything else is unchanged from v1.
 *
 ...
 * once on their next open. That is the intended, existing invalidation
 * mechanism — `TUTOR_LESSON_VERSION` is deliberately not touched.
 */
