/**
 * v3 of the Tutor *lesson* prompt.
 *
 * v2 added the "visual example" guidance. v3 adds a short Markdown-table
 * specification so truth tables, property comparisons and symbol tables are
 * emitted as standard multi-line pipe tables (rendered by RichText), never as
 * HTML or one-line squashed rows.
 *
