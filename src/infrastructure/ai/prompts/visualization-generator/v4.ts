/**
 * v4 visualization-generator prompt.
 *
 * Extends v3 with `eigen_2d` (linear algebra: eigenvalues / eigenvectors) and
 * keeps the same hard rule that a diagram may only reuse the exact matrix,
    ...
    JSON.stringify(
      {
        visualizations: [
          {
            type: 'function_2d | equation_2d | inequality_2d | points_2d | table_2d | vectors_2d | graph_2d | transform_2d | venn_2d | eigen_2d',
